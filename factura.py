...
def descargarFicheros(servidor, usuario, clave, directorioRemoto, directorioLocal):
    ...
    with FTP(servidor) as ftp:
        ...
        rutaLocal = os.getcwd() + "\\" + directorioLocal
...
def procesar2():
    ...
    factura.finalizarDocumento()
    here = os.path.dirname(__file__).join("facturas")
    ...
    rutaFichero = here.join("facturas")
...
if __name__ == '__main__':
    ...
    factura.leerJSON(nombreFichero="facturas/E_1290.json")
    destino = "facturas/E_1290.pdf"
    ...
    factura.finalizarDocumento(destino)
    

    server = '80.28.249.31'
    user = 'nando'
    clau = 'guardiola'
    destino = '/QIBM/facturasJson/kr/'
    origen = 'facturas/'

    conexio.subirFicheros(server, user, clau, destino, origen, extension=".pdf")

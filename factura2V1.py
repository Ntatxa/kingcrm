...
class FacturaPdf:
    ...
    def anyadirPagina(self):
        ...
        self.pdf.text(7, 64, "CODIGO CLIENTE")
        self.pdf.line(40, 60, 40, 75)
        self.pdf.text(42, 64, "AGENTE")
        self.pdf.line(108, 60, 108, 75)
        self.pdf.text(110, 64, "FECHA")
        self.pdf.line(168, 60, 168, 75)
        self.pdf.text(175, 64, "Nº FACTURA")
        
        self.pdf.rect(5, 80, 200, 150)
        
        self.pdf.line(5, 86, 205, 86)

        self.pdf.text(7, 84, "CODIGO")
        self.pdf.line(25, 80, 25, 230)
        self.pdf.text(42, 84, "DESCRIPCION")
        self.pdf.line(85, 80, 85, 230)
        self.pdf.text(90, 84, "CANTIDAD")
        ...
        self.pdf.text(140, 84, "PRECIO UNIDAD")
        self.pdf.line(168, 80, 168, 230)
        self.pdf.text(170, 84, "% DTO")
        self.pdf.line(182, 80, 182, 230)
        self.pdf.text(185, 84, "IMPORTE")
        
        self.pdf.rect(5, 235, 200, 30)

        self.yLinea = 239
        self.pdf.set_font("Arial", size=8)
        self.pdf.text(10, self.yLinea, "IMPORTE BRUTO")
        self.pdf.text(40, self.yLinea, "DESCUENTO")
        self.pdf.text(70, self.yLinea, "DESCUENTO.P.P")        
        ...
        self.pdf.text(10, 269, "CONDICIONES DE PAGO:")    
        self.pdf.rect(5, 270, 140, 20)

        self.pdf.rect(155, 270, 50, 20)
        self.pdf.set_font("Arial", size=10)
        self.pdf.text(160, 275, "TOTAL FACTURA")    

        self.pdf.image("LOGO_KR.jpg", 10, 10, 50, 50)
